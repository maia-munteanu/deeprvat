...
rule download_splicemaps:
    ...
    conda:
        "./absplice.yaml"
    shell:
        "timeout 50000 splicemap_download --version {params.version} --splicemap_dir {params.dirname} --tissues {wildcards.tissue}"
...
if absplice_main_conf["use_rocksdb"] == True:
    ...
    rule download_rocksdb:
        ...
        shell:
            "timeout 50000 spliceai_rocksdb_download --version {params.version} --db_path {output.spliceai_rocksdb} --chromosome {wildcards.chromosome}"
